...
import com.cnsworder.transgo.CameraView;
import com.cnsworder.transgo.CheckinActivity;
 ...
 * 正常签收。
 */
public class OrderCheckActivity extends QrCodeActivity implements Callback, OnClickListener {
    ...
    private void initView() {
        ...
        checkButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OrderCheckActivity.this, CheckinActivity.class);
                EditText order_editor = (EditText)findViewById(R.id.order_id);
                String ord_id = order_editor.getText().toString();
                intent.putExtra("order", ord_id);
                startActivityForResult(intent, REQUEST_CHECK);
            }
        });

        postOrderView = (ListView) findViewById(R.id.order_list_view);
        orderList = new ArrayList<>();
        orderList.add("111");
        orderList.add("111");
        orderList.add("111");
        orderList.add("222");
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.order_list_item, R.id.order_item, orderList);
        postOrderView.setAdapter(adapter);
    }

    private void initData() {
        CameraManager.init(this);
        mInactivityTimer = new InactivityTimer(OrderCheckActivity.this);
...
//            });
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        switch (requestCode) {
            ...
            case REQUEST_SYSTEM_PICTURE:
                ...
                break;
            case REQUEST_CHECK:
                String newOder = data.getStringExtra("order");
                orderList.add(newOder);
    ...
    private static class WeakHandler extends Handler {
        private WeakReference<OrderCheckActivity> mWeakQrCodeActivity;
        private DecodeManager mDecodeManager = new DecodeManager();

        public WeakHandler(OrderCheckActivity imagePickerActivity) {
            super();
        ...
        public void handleMessage(Message msg) {
            OrderCheckActivity qrCodeActivity = mWeakQrCodeActivity.get();
            switch (msg.what) {
        ...
        private void handleResult(String resultString) {
            OrderCheckActivity imagePickerActivity = mWeakQrCodeActivity.get();
