 ...
 * <p/>
 * 分派        postOrderView = (ListView) findViewById(R.id.post_order_list_view);
 ArrayList<String> orderList = new ArrayList<String>();
 orderList.add("111");
 orderList.add("222");
 postOrderView.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_expandable_list_item_1, orderList));
 。
 */
public class OrderPostActivity extends QrCodeActivity implements Callback, OnClickListener {
    ...
    private static Intent createIntent(Context context) {
        Intent i = new Intent(context, OrderPostActivity.class);
        return i;
    }
    ...
    private void initData() {
        ...
        mInactivityTimer = new InactivityTimer(OrderPostActivity.this);
...
//            });
    ...
    private static class WeakHandler extends Handler {
        private WeakReference<OrderPostActivity> mWeakQrCodeActivity;
        private DecodeManager mDecodeManager = new DecodeManager();

        public WeakHandler(OrderPostActivity imagePickerActivity) {
            super();
        ...
        public void handleMessage(Message msg) {
            OrderPostActivity qrCodeActivity = mWeakQrCodeActivity.get();
            switch (msg.what) {
        ...
        private void handleResult(String resultString) {
            OrderPostActivity imagePickerActivity = mWeakQrCodeActivity.get();
