...
package com.cnsworder.qrcodescanner.qrcode.camera;
...
import com.cnsworder.qrcodescanner.qrcode.utils.ScreenUtils;
...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        mCameraResolution = findCloselySize(ScreenUtils.getScreenWidth(mContext),
