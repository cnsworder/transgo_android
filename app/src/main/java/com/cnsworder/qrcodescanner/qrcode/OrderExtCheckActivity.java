 ...
 * 异常签收。
 */
public class OrderExtCheckActivity extends QrCodeActivity implements Callback, OnClickListener {
    ...
    private static Intent createIntent(Context context) {
        Intent i = new Intent(context, OrderExtCheckActivity.class);
        return i;
    }
    ...
    private void initView() {
        ...
        checkButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OrderExtCheckActivity.this, CheckinActivity.class);
                EditText order_editor = (EditText)findViewById(R.id.order_id);
                intent.putExtra("order_id", order_editor.getText());
        ...
        orderList.add("111");
        orderList.add("222");
        postOrderView.setAdapter(new ArrayAdapter<String>(this,  R.layout.order_list_item, R.id.order_item, orderList));

    }

    private void initData() {
        CameraManager.init(this);
        mInactivityTimer = new InactivityTimer(OrderExtCheckActivity.this);
...
//            });
    ...
    private static class WeakHandler extends Handler {
        private WeakReference<OrderExtCheckActivity> mWeakQrCodeActivity;
        private DecodeManager mDecodeManager = new DecodeManager();

        public WeakHandler(OrderExtCheckActivity imagePickerActivity) {
            super();
        ...
        public void handleMessage(Message msg) {
            OrderExtCheckActivity qrCodeActivity = mWeakQrCodeActivity.get();
            switch (msg.what) {
        ...
        private void handleResult(String resultString) {
            OrderExtCheckActivity imagePickerActivity = mWeakQrCodeActivity.get();
